...
namespace StudentRegistrationApp11.Views
{
...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentRegistrationDetails.aspx.cs" Inherits="StudentRegistrationApp11.Views.StudentRegistrationDetails" %>
...
////			var service = {};
		...
		app.controller('studCtrl', function ($scope, $http)
		{
			...
			$scope.saveStudent = function (student)
			{
				...
				{
					$http({
						url: "http://localhost:11645/Views/StudentRegistrationDetails.aspx/saveStudent",
						method: "POST",
				...
				{
					$http({
						url: "http://localhost:11645/Views/StudentRegistrationDetails.aspx/updateStudent",
						method: "POST",
						data: { StudentObj: angular.toJson(student) }
					}).then(OnSuccessSave, OnError);
				}
			...
			$scope.listStudents = function ()
			{
				...
				return $http({
					url: "http://localhost:11645/Views/StudentRegistrationDetails.aspx/getAllStudents",
					method: "GET",
					data: {},
			...
			$scope.editStudent = function (StudentID)
			{
				...
				$http({
					url: "http://localhost:11645/Views/StudentRegistrationDetails.aspx/findStudentById",
					method: "POST",
					data: { sid: StudentID }
			...
			$scope.deleteStudent = function (StudentID)
			{
				...
				$http({
					url: "http://localhost:11645/Views/StudentRegistrationDetails.aspx/deleteStudent",
					method: "POST",
					data: { sid: StudentID }
		...
		<div class="row">
			...
			<div class="col-md-10 main">
				<div ng-view="" ng-app="myApp" ng-controller="studCtrl">
					...
					<div class="form-group">
						...
						<div align="center">
							<button type="button" class="btn btn-info" ng-click="newStudent();" ng-disabled="!exampleForm.$valid">
								New</button>
							<button type="button" class="btn btn-success" ng-disabled="!exampleForm.$valid" ng-click="saveStudent(student);">Save
								{{btnName}}</button></div>
					</div>
					<br />
					<br />
					<button type="button" class="btn btn-group" ng-click="listStudents();">List Students</button>
					<br />
					<br />
					...
					<br />
					<br />
					<div>StudentName : {{student.fname}}</div>
					<br />
					<div>Selected Country : {{student.address.country}}</div>
					<br />
					{{student}}
					</form>
				</div>
